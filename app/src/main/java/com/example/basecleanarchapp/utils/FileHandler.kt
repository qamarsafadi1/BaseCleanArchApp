...
open class FileHandler {
    companion object {
        ...
        fun convertFileTotMultiPart(file: RequestBody, key: String, name: String): MultipartBody.Part {
        ...
        private fun convertUriListToFileList(context: Context, filesUris: ArrayList<Uri>): ArrayList<File> {
        ...
        fun decodeBitmap(
            ...
            try {
                ...
                var fileDescriptor: AssetFileDescriptor? = null
                try {
                    fileDescriptor = context.contentResolver.openAssetFileDescriptor(imagePath!!, "r")
                } catch (e: FileNotFoundException) {
                    e.printStackTrace()
                }
